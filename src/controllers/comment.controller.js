...
const updateComment = asyncHandler(async (req, res) => {
    ...
    if(!comment.owner.equals(req.user?._id)) throw new ApiError(403,"Only owner can update comment")
...
const deleteComment = asyncHandler(async (req, res) => {
    ...
    if(!comment.owner.equals(req.user?._id)) throw new ApiError(403,"Only owner can delete comment")
